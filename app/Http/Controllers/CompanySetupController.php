...
class CompanySetupController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('companies')->where('id', $id)->update([
            ...
            'default_vat_output_id'          => $request->default_vat_output_id ?: null,
            'default_vat_input_id'           => $request->default_vat_input_id ?: null,
            'default_retained_earnings_id'   => $request->default_retained_earnings_id ?: null,
