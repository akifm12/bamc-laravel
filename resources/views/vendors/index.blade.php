...
<div class="mb-4 flex items-center justify-between">
    <p class="text-sm text-gray-500">{{ count($vendors) }} vendors</p>
    <a href="/vendors/create" class="bg-green-700 text-white text-sm px-4 py-2 rounded hover:bg-green-800">➕ New Vendor</a>
</div>
        ...
        <tbody>
            ...
            <tr class="border-b border-gray-50 hover:bg-gray-50">
                ...
                <td class="px-4 py-2 text-right">
                    <a href="/vendors/{{ $v->id }}" class="text-xs text-blue-500 hover:text-blue-700">View →</a>
                </td>
            </tr>
            @empty
            <tr>
                <td colspan="9" class="px-4 py-8 text-center text-gray-400">No vendors found. <a href="/vendors/create" class="text-green-600">Add one →</a></td>
            </tr>
            @endforelse
        </tbody>
    </table>
